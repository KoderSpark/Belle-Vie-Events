...
const Footer = () => {
  ...
  return (
    <>
      <style>
        {`
          ...
          .bubble-light {
            ...
            box-shadow: 0 0 10px rgba(201, 191, 163, 0.2);
      ...
      <footer 
        className="text-[#E8DFC8] pt-24 pb-12 relative z-10 mt-auto overflow-hidden bg-cover bg-center bg-no-repeat border-t border-[#C9BFA3]/20"
        style={{ backgroundImage: "url('https://images.unsplash.com/photo-1517457373958-b7bdd4587205?q=80&w=2048&auto=format&fit=crop')" }}
      >
        {/* Dark Tint Overlay */}
        <div className="absolute inset-0 bg-[#0D1A26]/95 z-0" />

        {/* Subtle gold glow at the top */}
        <div className="absolute top-0 left-1/2 -translate-x-1/2 w-[80%] h-[1px] bg-gradient-to-r from-transparent via-[#C9BFA3]/50 to-transparent opacity-40 z-10" />
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-12 lg:gap-20 mb-20">
              ...
              <div className="flex flex-col items-center md:items-start text-center md:text-left">
                ...
                <div className="flex gap-4">
                  {[
                    { Icon: Instagram, href: "https://www.instagram.com/hausofvelourabyjp?igsh=MWMwaDV2ZGY5MXQwdg%3D%3D&utm_source=qr" },
                    { Icon: Facebook, href: "#" },
                    { Icon: Linkedin, href: "#" }
                  ].map((s, idx) => (
                    <a key={idx} href={s.href} target="_blank" rel="noopener noreferrer" className="w-10 h-10 rounded-full border border-[#C9BFA3]/30 flex items-center justify-center text-[#C9BFA3] hover:bg-[#C9BFA3] hover:text-[#0D1A26] transition-all duration-300">
              ...
              {/* Quick Links */}
              <div className="flex flex-col items-center md:items-start text-center md:text-left">
                <h4 className="text-[#E8DFC8] text-[10px] tracking-[0.3em] uppercase font-bold mb-8">Quick Links</h4>
                <ul className="space-y-4 text-sm font-sans-elegant">
                  {["Home", "Services", "Gallery", "About", "Contact"].map((l) => (
                    <li key={l}>
                      <Link to={l === "Home" ? "/" : `/${l.toLowerCase()}`} className="text-[#F5F0E6]/60 hover:text-[#C9BFA3] transition-colors duration-300 tracking-wide">
                        {l}
                      </Link>
                    </li>
                  ))}
              ...
              <div className="flex flex-col items-center md:items-start text-center md:text-left font-sans-elegant">
                <h4 className="text-[#E8DFC8] text-[10px] tracking-[0.3em] uppercase font-bold mb-8">Contact Us</h4>
